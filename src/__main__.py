...
from sloppatch.apply import PatchConfig, apply_patch, prepare_masked_patch, prepare_file_cache
...
def main(argv: List[str]):
    ...
    output_file_temp = args.input_file.parent / (args.input_file.name + "." + create_random_suffix())
